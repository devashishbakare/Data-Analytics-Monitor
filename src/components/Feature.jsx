  ...
  return (
    <>
      <div className="h-full w-full flex flex-col items-center justify-center gap-3">
        <span className="h-[10%] w-full flex items-center justify-center text-center uppercase text-[#00df9a] md:text-[1.5rem]">
          growing with data analytics
        </span>
        <span className="text-white h-[25%] w-full flex items-center justify-center text-[2.8rem] font-bold text-center capitalize md:text-[4.5rem] gap-0">
          grow with data
        </span>
